...
public class tour_cost extends javax.swing.JFrame {
    ...
    public void tableload() {
        ...
        dtm.setRowCount(0);
        try {
            ResultSet rs = DB.search("select * from t_cost where t_id = '" + jTextField1.getText() + "'");
            while (rs.next()) {
    ...
    public void idload() {
        try {
            ResultSet rs = DB.search("select id from t_cost order by id desc");
            if (rs.next()) {
                String id = rs.getString("id");
                int id1 = Integer.parseInt(id) + 1;
                jLabel12.setText(String.valueOf(id1));
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Tour ID", "Name", "Passport Number", "Start Date", "End Date", "Discription", "Unit Price", "Quantity", "Amount"
            }
        ) {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
        jLabel12.setText(dtm.getValueAt(jTable1.getSelectedRow(), 0).toString());
        ...
        jTextField6.setText(dtm.getValueAt(jTable1.getSelectedRow(), 6).toString());
        jTextField7.setText(dtm.getValueAt(jTable1.getSelectedRow(), 7).toString());
        jTextField8.setText(dtm.getValueAt(jTable1.getSelectedRow(), 8).toString());
        jTextField9.setText(dtm.getValueAt(jTable1.getSelectedRow(), 9).toString());
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (jTextField2.getText().equals("")) {
            ...
            if (option == JOptionPane.OK_OPTION) {
                ...
                if (password.equals("123")) {
                    try {
                        DB.iud("delete from t_cost where id = '" + jLabel12.getText() + "' ");
        ...
        try {
            ...
            if (jRadioButton1.isSelected()) {
                ...
                while (rs1.next()) {
                    ...
                    for (int i = 0; i < dtm.getRowCount(); i++) {
                        ResultSet rs2 = DB.search("select * from t_cost where t_id = '" + dtm.getValueAt(i, 1).toString() + "' ");
                        if (rs2.next()) {
                            sum = sum + Double.parseDouble(dtm.getValueAt(i, 9).toString());
                        }
            ...
            if (jRadioButton2.isSelected()) {
                ...
                while (rs1.next()) {
                    ...
                    double sum = 0;
                    for (int i = 0; i < dtm.getRowCount(); i++) {
                        ResultSet rs2 = DB.search("select * from t_cost where pass_num = '" + dtm.getValueAt(i, 3).toString() + "' ");
                        if (rs2.next()) {
                            sum = sum + Double.parseDouble(dtm.getValueAt(i, 9).toString());
                        }
                        jLabel11.setText(String.valueOf(sum));
