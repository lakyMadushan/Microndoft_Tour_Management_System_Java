 ...
 */
public class t_t_status extends javax.swing.JFrame {
        ...
        if (jTextField1.getText().equals("")) {
            ...
            try {
                if (jTextField1.getText().equals("")) {
                    ...
                    DB.iud("insert into status (state) values ('" + jTextField1.getText() + "')");
        ...
        if (jLabel4.getText().equals("0")) {
            ...
            if (option == JOptionPane.OK_OPTION) {
                ...
                if (password.equals("123")) {
                    try {
                        DB.iud("delete from status where id = '" + jLabel4.getText() + "' ");
        ...
        try {
            if (jLabel4.getText().equals("0") || jTextField1.getText().equals("")) {
                ...
                if (option == JOptionPane.OK_OPTION) {
                    String password = new String(passwordField.getPassword());
                    if (password.equals("123")) {
                        DB.iud("update status set "
                                + " state = '" + jTextField1.getText() + "' where id = '" + jLabel4.getText() + "' ");
                        jTextField1.setText("");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try {
            ...
            if (jTable1.getSelectedRow() != -1) {
                ...
                String state = dtm.getValueAt(jTable1.getSelectedRow(), 1).toString();
    ...
    private void tableLoad() {
        try {
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.search("select * from status");
            while (rs.next()) {
    ...
    private void idLoad() {
        try {
            ResultSet rs = DB.search("select id from status order by id DESC");
            if (rs.next()) {
