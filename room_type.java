...
public class room_type extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            if (jTextField1.getText().equals("")) {
                ...
                DB.iud("insert into r_type (type) values ('" + jTextField1.getText() + "')");
        ...
        if (jLabel4.getText().equals("0")) {
            ...
            if (option == JOptionPane.OK_OPTION) {
                ...
                if (password.equals("123")) {
                    try {
                        DB.iud("delete from r_type where id = '" + jLabel4.getText() + "' ");
        ...
        try {
            if (jLabel4.getText().equals("0") || jTextField1.getText().equals("")) {
                ...
                if (option == JOptionPane.OK_OPTION) {
                    String password = new String(passwordField.getPassword());
                    if (password.equals("123")) {
                        DB.iud("update r_type set "
                                + " type = '" + jTextField1.getText() + "' WHERE id = '" + jLabel4.getText() + "' ");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try {
            ...
            if (jTable1.getSelectedRow() != -1) {
                ...
                String type = dtm.getValueAt(jTable1.getSelectedRow(), 1).toString();
                jLabel4.setText(id);
    ...
    private void tableLoad() {
        try {
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.search("select * from r_type");
            while (rs.next()) {
    ...
    private void idLoad() {
        try {
            ResultSet rs = DB.search("select id from r_type order by id DESC");
            if (rs.next()) {
