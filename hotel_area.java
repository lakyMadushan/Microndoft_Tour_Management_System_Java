 ...
 */
public class hotel_area extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            if (jTextField1.getText().equals("")) {
                ...
                DB.iud("insert into hotel_area (Area) values ('" + jTextField1.getText() + "')");
        ...
        if (jLabel4.getText().equals("0")) {
            ...
            if (option == JOptionPane.OK_OPTION) {
                ...
                if (password.equals("123")) {
                    try {
                        DB.iud("delete from hotel_area where id = '" + jLabel4.getText() + "' ");
        ...
        try {
            if (jLabel4.getText().equals("0") || jTextField1.getText().equals("")) {
                ...
                if (option == JOptionPane.OK_OPTION) {
                    String password = new String(passwordField.getPassword());
                    if (password.equals("123")) {
                        DB.iud("update hotel_area set "
                                + " Area = '" + jTextField1.getText() + "' where id = '" + jLabel4.getText() + "' ");
                        jTextField1.setText("");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try {
            ...
            if (jTable1.getSelectedRow() != -1) {
                ...
                String area = dtm.getValueAt(jTable1.getSelectedRow(), 1).toString();
    ...
    private void tableLoad() {
        try {
            DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
            dtm.setRowCount(0);
            ResultSet rs = DB.search("select * from hotel_area");
            while (rs.next()) {
    ...
    private void idLoad() {
        try {
            ResultSet rs = DB.search("select id from hotel_area order by id DESC");
            if (rs.next()) {
