...
//    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tour ID", "Name", "Country", "Passport Num", "Contact Num", "Email", "Edelts", "Childs", "Start Date", "End Date"
            }
        ) {
        ...
        jLabel8.setText("Client Search By :");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jPanel6, javax.swing.GroupLayout.DEFAULT_SIZE, 1535, Short.MAX_VALUE)
                            .addComponent(jPanel8, javax.swing.GroupLayout.DEFAULT_SIZE, 1535, Short.MAX_VALUE)
...
//            jDateChooser2.setDate(null);
                ...
                DefaultTableModel dtm = (DefaultTableModel) jTable1.getModel();
                dtm.setRowCount(0);
                ResultSet rs1 = DB.search("select * from t_create where t_id like '%" + jTextField12.getText() + "%'");
                while (rs1.next()) {
                    //Vector v = new Vector();
                    Vector<Object> v = new Vector<>();

                    v.add(rs1.getString("t_id"));
                    v.add(rs1.getString("t_name"));
                    v.add(rs1.getString("country"));
                    v.add(rs1.getString("pass_num"));
                    v.add(rs1.getString("contact_num"));
                    v.add(rs1.getString("email"));
                    v.add(rs1.getString("adelts"));
                    v.add(rs1.getString("childs"));
